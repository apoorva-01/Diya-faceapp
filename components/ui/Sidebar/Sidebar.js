...
const structure = [
  ...
  { id: 7, label: "Help", link: "mailto:diyakataria222@gmail.com", icon: <HelpOutlineIcon /> },
  { id: 10, type: "divider" },
  { id: 11, type: "title", label: "CONTACT" },
  // {
  //   id: 13,
  //   label: "Github",
  //   link: "https://github.com/jyotiyadav-05",
  //   icon: <GitHubIcon/>
  // },
  {
    id: 14,
    label: "Linkedin",
    link: "https://www.linkedin.com/in/diya-kataria-846117241",
    icon: <LinkedInIcon/>,
  },
];
