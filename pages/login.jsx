      ...
      <Grid container component="main" sx={{ height: '10vh' }}>
        ...
        <Grid item xs={12} sm={8} lg={5} component={Paper} elevation={6} square>
          ...
          <form onSubmit={handleSubmit(submitHandler)} >
            ...
            >
              <Image sx={{}} src='/igdtuw_logo.png'width={300} height={300}alt={'Microsoft'} ></Image>
              </Box>
              ...
              <Box sx={{ mt: 0 }}>
                ...
                />
                  ...
                  <Button className='hvr-grow' type="submit" 
                    style={{ width: '100%', backgroundColor: '#344720', color: 'white', marginTop: '2rem', marginBottom: '3rem' }} >
                    Log In
                  </Button>
